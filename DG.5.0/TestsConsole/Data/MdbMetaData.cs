...
namespace TestsConsole.Data
{
    class MdbMetaData
    {
        public static void Run()
        // From https://learn.microsoft.com/ru-ru/dotnet/api/system.data.sqlclient.sqlconnection.getschema?view=dotnet-plat-ext-7.0
        {
            ...
            using (var conn = new OleDbConnection(connectionString))
            {
                ...
                var sql = "SELECT MSysObjects.Name, MSysObjects.Type From MsysObjects";
                ...
                var dtCols = conn.GetSchema("Columns", new[] { null, null, "Categories" });
                ...
                tableRestrictions[2] = "Categories";

                DataTable courseTableSchemaTable = conn.GetSchema("Tables", tableRestrictions);

                Console.WriteLine("Schema Information of Categories Tables:");
