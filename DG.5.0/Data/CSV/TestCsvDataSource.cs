...
namespace Data.CSV
{
    ...
    {
        public TestCsvCommand(TestCsvConnection connection) => DbConnection = connection;
        ...
        protected override DbDataReader ExecuteDbDataReader(CommandBehavior behavior) => new TestCsvDataReader(this);
    ...
    public class TestCsvDataReader : DbDataReader
    {
        ...
        public TestCsvDataReader(TestCsvCommand cmd) => _cmd = cmd;
