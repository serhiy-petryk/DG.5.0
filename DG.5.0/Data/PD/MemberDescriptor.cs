    ...
    public class MemberDescriptor<T> : PropertyDescriptor, IMemberDescriptor
    {
        ...
        public MemberDescriptor(string path) : base(path, new Attribute[0])
        {
            ...
            if (a != null)
            {
                ...
                _dbNullValue = Helpers.Types.CastDbNullValue(_dbNullValue, PropertyType, ComponentType.Name + "." + PropertyType.Name);
        ...
        {
            get { return string.Join(Settings.MDelimiter, _members); }
        }
