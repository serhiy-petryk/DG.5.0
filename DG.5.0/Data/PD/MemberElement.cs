...
namespace Data.PD
{
  public partial class MemberElement
  {
    ...
    public MemberElement(MemberElement owner, Type instanceType, List<string> memberNames)
    {
      ...
      Type notNullType = Helpers.Types.GetNotNullableType(this._instanceType);
      ...
      {// No error
        ...
        if (this._parent == null)
        {
          ...
          while (e != null)
          {
            ...
            if (!_canBeNull) _canBeNull = (e.ReturnType.IsClass || Helpers.Types.IsNullableType(e.ReturnType)) && e._child != null;
          ...
          if (this._error == null)
          {
            _lastNullableReturnType = this._canBeNull ? Helpers.Types.GetNullableType(this._lastReturnType) : this._lastReturnType;
        ...
        if (memberName.Contains(Settings.MDelimiter))
        {
          var parts = memberName.Split(new[] {Settings.MDelimiter}, StringSplitOptions.None);
