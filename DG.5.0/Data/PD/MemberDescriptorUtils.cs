...
namespace Data.PD
{
    public class MemberDescriptorUtils
    {
        ...
        public static MemberInfo[] GetMemberInfos(Type type, bool includeFields, bool includeMethods)
        {
            ...
            Type t = Helpers.Types.GetNotNullableType(type);
        ...
        public static List<FieldInfo> GetPublicFields(Type type)
        {
            ...
            for (int i = 0; i < aFI.Length; i++)
            {
                ...
                if (flag1 && Helpers.Types.GetTypeOfType(fi.DeclaringType) == Helpers.Types.TypeKind.Enum && fi.Name == "value__") flag1 = false;
                if (flag1) fis.Add(fi);
            }
            return fis;
        }
