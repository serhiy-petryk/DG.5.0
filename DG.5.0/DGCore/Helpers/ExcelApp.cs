...
namespace DGCore.Helpers
{
    ...
    public class ExcelApp : IDisposable
    {
        ...
        {
            string format = null;
            if (visualStudioDateTimeFormat.Length == 1)
            {// Char == DateTime patern is used
                char x;
        ...
        public ExcelApp(string filename, bool isFilenameTemplate)
        {
            ...
            if (oApp == null)
            {// No Active excel app object == you need to create it
